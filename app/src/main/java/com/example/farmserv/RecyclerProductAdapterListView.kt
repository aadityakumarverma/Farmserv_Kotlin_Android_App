...
class RecyclerProductAdapterListView(val context: Context, val arrProduct: ArrayList<ProductModel>,val click:ProductViewClick) : RecyclerView.Adapter<RecyclerProductAdapterListView.ViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(LayoutInflater.from(context).inflate(R.layout.product_layout_list_view, parent, false))
    }
